...
with st.sidebar:
    ...
    selected = option_menu(
        menu_title=None,
        options=["HOME", "DETECT", "DETAILS", "INSIGHTS"],  # List of navigation options
        icons=["house-fill", "cloud-arrow-up-fill", "box-fill", "clipboard-data-fill","bezier"],  # Icons corresponding to each option
